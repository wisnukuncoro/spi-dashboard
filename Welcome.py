...
if excel is not None:
    ...
    if long_date[-4:] != '2025':
        ...
        **Upload file sukses!**                
        ...
        rasio = {
            'bulanan': growth_siswa.loc[86, ['bulanan_2018', 'bulanan_2019', 'bulanan_2020', 'bulanan_2021', 'bulanan_2022', 'bulanan_2023', 'bulanan_2024', 'bulanan']],
            'rasio': growth_siswa.loc[87, ['bulanan_2018', 'bulanan_2019', 'bulanan_2020', 'bulanan_2021', 'bulanan_2022', 'bulanan_2023', 'bulanan_2024', 'bulanan']],
        }
        
        rasio['jumlah_cabang'] = rasio['bulanan']/rasio['rasio']
        
        rasio = pd.DataFrame(data=rasio)
